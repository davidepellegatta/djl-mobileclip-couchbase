...
public class ReplicationManager implements AutoCloseable {
    ...
    public static class AuthenticatorBuilder {
        final CouchbaseLiteProperties.AuthenticatorProperties properties;
        public AuthenticatorBuilder(CouchbaseLiteProperties.AuthenticatorProperties authenticator) {
